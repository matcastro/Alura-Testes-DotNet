...
namespace Alura.CoisasAFazer.Tests
{
    public class GerenciaPrazoDasTarefasHandlerExecute
    {
        ...
        public void QuandoTarefasEstiveremAtrasadasDeveMudarSeuStatus()
        {
            ...
            var casaCateg = new Categoria(22, "Casa");
            var trabCateg = new Categoria(33, "Trabalho");
            var saudCateg = new Categoria(44, "Saúde");
            var higiCateg = new Categoria(55, "Higiene");

            var tarefas = new List<Tarefa>
            {
                //atrasadas a partir de 1/1/2019
                new Tarefa(11, "Tirar lixo", casaCateg, new DateTime(2018,12,31), null, StatusTarefa.Criada),
                ...
                new Tarefa(7, "Concluir o relatório", trabCateg, new DateTime(2018,5,7), null, StatusTarefa.Criada),
